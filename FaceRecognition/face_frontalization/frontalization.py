...
class Frontalization(object):
    ...
    def frontalize_2d(self, img):
        imgDim  = 96
        predictor = dlib.shape_predictor(os.path.dirname(os.path.abspath(__file__)) + "/dlib_models/" + "shape_predictor_68_face_landmarks.dat")
        bb = dlib.rectangle(left = 0, top = 0, right = img.shape[1], bottom = img.shape[0])
