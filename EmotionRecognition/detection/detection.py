...
def main():
    j = 1
    for filename in os.listdir("/home/richard/Desktop/faces"):
	color  = cv2.imread("/home/richard/Desktop/faces" + "//" + filename)
    	...
    	cv2.imwrite("/home/richard/Desktop/NewResults/_" + str(j) +  "_" + "Face!.jpg", color)	
	j += 1
